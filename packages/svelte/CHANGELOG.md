...
- [#24](https://github.com/nerdslabs/teiler/pull/24) [`b80ec31`](https://github.com/nerdslabs/teiler/commit/b80ec31ae54cc6e4d9ad96b312503f3a9802bc05) Thanks [@drozdzynski](https://github.com/drozdzynski)! - Declare `svelte` as a peer dependency instead of a dependency, so apps use their own Svelte 4 copy

- [#24](https://github.com/nerdslabs/teiler/pull/24) [`b80ec31`](https://github.com/nerdslabs/teiler/commit/b80ec31ae54cc6e4d9ad96b312503f3a9802bc05) Thanks [@drozdzynski](https://github.com/drozdzynski)! - Bundle a single copy of `@teiler/core` instead of two
